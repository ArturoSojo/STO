    ...
    <div class="full-box nav-lateral-content scroll">
        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <li>
                    <a href="javascript:void(0);" class="nav-btn-submenu"><i class="fas fa-file-invoice-dollar fa-fw"></i> &nbsp; Pedidos <i class="fas fa-chevron-down"></i></a>
                    <ul>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/pedido-realizado-list/"><i class="fas fa-file-invoice-dollar fa-fw"></i> &nbsp; Pedidos realizados</a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/pedido-list/"><i class="fas fa-truck-loading fa-fw"></i> &nbsp; Pedidos pendientes</a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/pedido-search/"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; Buscar pedido</a>
                        </li>
                    </ul>
                </li>
                 ...
                 <li>
                    <a href="javascript:void(0);" class="nav-btn-submenu"><i class="fas fa-folder fa-fw"></i> &nbsp; Accesibilidad <i class="fas fa-chevron-down"></i></a>
                    <ul>
                         <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/reportes/" class="nav-btn-submenu">
                            <i class="fas fa-file"> &nbsp; Reportes</i>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/visitas/" class="nav-btn-submenu">
                            <i class="fas fa-eye"> &nbsp; Últimas Visitas</i>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD."/notificacion/".$ins_login->encryption($_SESSION['id_sto']);?>/" class="nav-btn-submenu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD."/security/".$ins_login->encryption($_SESSION['id_sto']); ?>/"><i class="fas fa-lock fa-fw"></i> &nbsp; Seguridad</a>
                        </li>
                    </ul>
                </li>
