        ...
        <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="form-outline mb-4">
                            <input type="text" class="form-control" value="<?php echo $campos['producto_costo_envio']; ?>" id="producto_costo_envio" readonly >
                            <label for="producto_costo_envio" class="form-label">Costo del Envio</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="form-outline mb-4">
                            <input type="text" class="form-control" value="<?php echo $total_price+$campos['producto_costo_envio']; ?>" id="producto_precio_venta_final" readonly >
                            <label for="producto_precio_venta_final" class="form-label">Precio de venta final </label>
                        </div>
                    </div>
