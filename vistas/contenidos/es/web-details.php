        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-lg-7">
                    ...
                    <p class="font-weight-bold text-uppercase" style="font-size: 22px;"><i class="fas fa-shipping-fast fa-fw"></i> Costo del Envio: <span class="text-primary"><?php echo  COIN_SYMBOL.number_format($campos['producto_costo_envio'],COIN_DECIMALS,COIN_SEPARATOR_DECIMAL,COIN_SEPARATOR_THOUSAND).' '.COIN_NAME; ?></span></p>
                    
                    <!-- Agregar al carrito -->
                    <form method="POST" class="FormularioAjax" data-form="save" data-lang="<?php echo LANG ?>" action="<?php echo SERVERURL ?>ajax/carritoAjax.php" style="padding-top: 70px;">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-outline mb-4">
                            <input type="hidden" name="modulo_carrito" value="agregar">
                            <input type="hidden" name="producto" value="<?php echo $ins_login->encryption($campos['producto_id'])?>">
                            <input type="hidden" name="cliente" value="<?php echo $ins_login->encryption($_SESSION['id_sto'])?>">
                                        <input type="number" value="1" class="form-control text-center" name="cantidad" pattern="[0-9]{1,10}" maxlength="10" >
