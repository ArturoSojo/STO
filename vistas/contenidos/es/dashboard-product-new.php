            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                     ...
                     <div class="col-12 col-md-4">
                        <div class="form-outline mb-4">
                            <input type="text" pattern="[0-9.]{1,25}" class="form-control" name="producto_costo_envio_reg" id="producto_costo_envio" maxlength="25">
                            <label for="producto_costo_envioa" class="form-label">Costo de Envio <?php echo FIELD_OBLIGATORY; ?></label>
                        </div>
                    </div>
