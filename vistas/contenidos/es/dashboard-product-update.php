            ...
            <fieldset class="mb-4">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-outline mb-4">
                                <input type="text" pattern="[0-9.]{1,25}" class="form-control" name="producto_costo_envio_up" value="<?php echo $campos['producto_costo_envio']; ?>" id="producto_costo_envio" maxlength="25">
                                <label for="producto_costo_envio" class="form-label">Costo del Envio<?php echo FIELD_OBLIGATORY; ?></label>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-outline mb-4">
