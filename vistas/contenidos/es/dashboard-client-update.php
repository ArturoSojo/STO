...
<?php  }else if($_SESSION["cargo_sto"] == "Usuario") {?>

    <div class="full-box page-header">
    <h3 class="text-start roboto-condensed-regular text-uppercase">
        <i class="fas fa-sync-alt fa-fw"></i> &nbsp; Actualizar Cuenta
    </h3>
    </div>
...
<div class="container-fluid">
    ...
    <form class="dashboard-container FormularioAjax" method="POST" data-form="update" data-lang="<?php echo LANG; ?>" autocomplete="off" action="<?php echo SERVERURL;?>ajax/clienteAjax.php" >
        ...
        <input type="hidden" name="cliente_id_up" value="<?php echo $ins_login->encryption($campos['cliente_id']);?>">
        <?php } ?>
        <fieldset class="mb-4">
        ...
        <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-start">Si desea <strong>actualizar la contraseña</strong> debe de introducir una nueva contraseña y repetirla. Por el contrario, <strong>si no desea actualizarla</strong> deje vacíos los campos.</p>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
        ...
        <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
                            <input type="text"  class="form-control" name="usuario_usuario_up" id="usuario_usuario" maxlength="30">
