                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        <div class="form-online mb-4">
                            <textarea class="form-control" name="Modos_de_Pago" style="height: 400px;"> <?php echo $campos['metodos_de_pago']; ?></textarea>
                            <label for="Modos_de_Pago" class="form-label"><i>Indique de manera detallada los modos de pago que ofrece, con sus respectivos datos para efectuar el pago.<?php echo FIELD_OBLIGATORY; ?></i></label>
                        </div>
                    </div>
                </div>
            </div>
       ...
       <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-12">
                        <div class="form-outline mb-4">
                            <textarea class="form-control" name="Modos_de_Pago" style="height: 400px;"></textarea>
                            <label for="Modos_de_Pago" class="form-label"><i>Indique de manera detallada los modos de pago que ofrece, con sus respectivos datos para efectuar el pago.<?php echo FIELD_OBLIGATORY; ?></i></label>
                        </div>
                    </div>
                </div>
