<?php
	...
	class empresaControlador extends mainModel{
        ...
        public function registrar_empresa_controlador(){
            ...
            $modos_pagos=mainModel::limpiar_cadena($_POST['Modos_de_Pago']);

            /*-- Comprobando campos vacios - Checking empty fields --*/
            if($tipo_documento=="" || $numero_documento=="" || $nombre=="" || $modos_pagos==""){
                $alerta=[
					"Alerta"=>"simple",
			...
			$datos_empresa_reg=[
                ...
                "metodos_de_pago"=>[
					"campo_marcador"=>":Modos",
					"campo_valor"=>$modos_pagos
				]
            ];
