<?php
	...
	class productoControlador extends mainModel{
        ...
        public function registrar_producto_controlador(){
            ...
            $costo_envio=mainModel::limpiar_cadena($_POST['producto_costo_envio_reg']);
            ...
            $datos_producto_reg=[
                ...
                "producto_costo_envio"=>[
                    "campo_marcador"=>":CostoE",
                    "campo_valor"=>$costo_envio
                ],
                "producto_descuento"=>[
					...
					$tabla.='
                        <div class="card-product div-bordered bg-white shadow-2">
                            ...
                            <div class="card-product-body">
                                ...
                                <input type="hidden" name="producto" value="'.mainModel::encryption($rows['producto_id']).'">
                                ...
                                <div class="text-center card-product-options" style="padding: 10px 0;">
                                    ...
                                    &nbsp; &nbsp;
                                    <form method="POST" class="FormularioAjax" data-form="save" data-lang="'.LANG.'" action="'.SERVERURL.'ajax/favoritoAjax.php" style="display: inline-block">
                                <input type="hidden" name="modulo_favorito" value="agregar">
                                <input type="hidden" name="producto" value="'.mainModel::encryption($rows['producto_id']).'">
                                    <button type="submit" class="btn btn-link btn-sm btn-rounded text-danger" ><i class="fas fa-heart fa-fw"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        public function actualizar_producto_controlador(){
            ...
            $costo_envio=mainModel::limpiar_cadena($_POST['producto_costo_envio_up']);
