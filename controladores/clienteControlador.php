	...
	class clienteControlador extends mainModel{
		...
		public function actualizar_cliente_controlador(){
            ...
            if(isset($_SESSION['cargo_sto']) && ($_SESSION['cargo_sto']=="Administrador" || $_SESSION['cargo_sto']=="Usuario")){
                ...
                $check_cuenta=mainModel::ejecutar_consulta_simple("SELECT cliente_id FROM cliente WHERE cliente_email='$usuario_usuario' AND cliente_clave='$usuario_clave' AND cliente_cuenta_estado='Activa'");
            }else{
